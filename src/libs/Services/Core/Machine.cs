...
namespace svc
{
	...
	/*
	public class ShieldedConnect
	{
		public string address		= "0.0.0.0";
		public ushort portLow   = 0;
		public ushort portHigh	= 0;
	}

	public class ShieldedConnections
	{
		public ShieldedConnect	conn;
		public DateTime					firstConnectedAt;
		public string						addedReason;
		public DateTime					lastConnectedAt;
		public ulong            connectionAttempts;
		public ulong            connectionSuccesses;
		public ulong            connectionFailures;
	}
	...
	*/
	...
	public class MachineCfg : lib.Config
	{
		...
		//public List<ShieldedConnect> connections = new List<ShieldedConnect>();
	...
	public class Machine : ServiceWithConfig<MachineCfg>, IMachine, lib.IProcess
	{
		...
		// @@@ TODO : Get rid of this now that we have ShieldedGossip?
		Socket m_sock;
		net.Conn m_conn;
